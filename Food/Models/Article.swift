...
var articleData = [
    ...
    Article(id: 3, image: "News4-20Big", title: "奋进新征程，扬帆再起航", date: "2022.10.26",stars: 5, isStared: false, context: "    2022年10月16日，计算机学院各学生支部组织集中收看党的二十大开幕会，部分代表赴晨兴音乐厅观看，其余同志在各支部分会场集中观看。计算机学院全体党支部认真做好学习宣传贯彻党的二十大精神各项工作，组织全体成员认真学习习近平总书记在大会上所作的报告，深入开展学习交流研讨，学院迅速兴起学习宣传贯彻党的二十大精神热潮。", type:"党政建设"),
    Article(id: 4, image: "News5-Chairman", title: "计算机学院2022年学生代表大会召开", date: "2022.11.09",stars: 3, isStared: false, context: "2022 年11月9日下午，北京航空航天大学计算机学院2022 年学生代表大会在新主楼G849胜利召开，大会圆满完成了各项任务。计算机学院党委副书记冯维成老师、计算机学院分团委书记王婧仪、校学生会代表王浦航、兄弟学院学生会代表出席会议。计算机学院学生代表102人参加会议，代表学院七百余名本科生行使民主权利，参与学院民主建设。\n此次大会听取《北京航空航天大学计算机学院 2022年代表资格审查报告》、《北京航空航天大学计算机学院2022年学生会工作述职报告》；听取、审议并表决《北京航空航天大学计算机学院学生会章程（草案）》、《北京航空航天大学计算机学院 2022年学生代表大会主席团选举办法》；选举产生了计算机学院2022年学生会主席团。", type: "学院活动"),
]
